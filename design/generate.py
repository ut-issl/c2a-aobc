...
c2a_generator.cmd_csv.generate(
    root_path / "design/cmd.csv",
    root_path / "tlm-cmd-db/CMD_DB/X_AOBC_CMD_DB_CMD_DB.csv",
    "AOBC",
)
...
c2a_generator.bct_csv.generate(
    bct_src, root_path / "tlm-cmd-db/CMD_DB/X_AOBC_CMD_DB_BCT.csv"
)
...
c2a_generator.tlm_csv.generate(
    tlm_path, root_path / "tlm-cmd-db/TLM_DB", prefix="X_AOBC_TLM_DB_"
)
