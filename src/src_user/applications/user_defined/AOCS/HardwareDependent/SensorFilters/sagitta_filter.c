...
static int APP_SAGITTA_FILTER_init_spike_filter_(void)
{
  sagitta_filter_.q_i2b_spike_filter_config.count_limit_to_accept =
    SAGITTA_PARAMETERS_q_i2b_spike_filter_config_count_limit_to_accept;
  sagitta_filter_.q_i2b_spike_filter_config.count_limit_to_reject_continued_warning =
    SAGITTA_PARAMETERS_q_i2b_spike_filter_config_count_limit_to_reject_continued_warning;
  sagitta_filter_.q_i2b_spike_filter_config.reject_threshold =
    SAGITTA_PARAMETERS_q_i2b_spike_filter_config_reject_threshold_rad;
