...
typedef enum
{
  ...
  EH_RULE_TLM_ERROR_NANOSSOC_D60_PY        = 5,
  EH_RULE_TLM_ERROR_NANOSSOC_D60_MY        = 6,
  EH_RULE_TLM_ERROR_NANOSSOC_D60_PZ        = 7,
  EH_RULE_TLM_ERROR_NANOSSOC_D60_MZ        = 8,
  ...
  EH_RULE_CHECKSUM_ERROR_NANOSSOC_D60_PY   = 26,
  EH_RULE_CHECKSUM_ERROR_NANOSSOC_D60_MY   = 27,
  EH_RULE_CHECKSUM_ERROR_NANOSSOC_D60_PZ   = 28,
  EH_RULE_CHECKSUM_ERROR_NANOSSOC_D60_MZ   = 29,
