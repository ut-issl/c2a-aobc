...
uint8_t OEM7600_PARAMETERS_gpstime_total_msec_spike_filter_config_count_limit_to_accept = 5;
uint8_t OEM7600_PARAMETERS_gpstime_total_msec_spike_filter_config_count_limit_to_reject_continued_warning = 60;
double OEM7600_PARAMETERS_gpstime_total_msec_spike_filter_config_reject_threshold_ms = 3000.0;
double OEM7600_PARAMETERS_gpstime_total_msec_spike_filter_config_amplitude_limit_to_accept_as_step_ms = 3000.0;
