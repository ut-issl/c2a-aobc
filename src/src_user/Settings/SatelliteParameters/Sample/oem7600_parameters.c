...
uint8_t OEM7600_PARAMETERS_gps_time_total_sec_spike_filter_config_count_limit_to_accept = 5;
uint8_t OEM7600_PARAMETERS_gps_time_total_sec_spike_filter_config_count_limit_to_reject_continued_warning = 60;
double OEM7600_PARAMETERS_gps_time_total_sec_spike_filter_config_reject_threshold_s = 3000.0;
double OEM7600_PARAMETERS_gps_time_total_sec_spike_filter_config_amplitude_limit_to_accept_as_step_s = 3000.0;
