...
// Frame conversion
const Quaternion NANOSSOC_D60_PARAMETERS_quaternion_c2b[NANOSSOC_D60_PARAMETERS_NUMBER_OF_MOUNTED_SENSOR] = { 0.70710665f, 0.0f, 0.0f, 0.70710665f,    // ID 0
                                                                                                              0.0f, -0.70710665f, 0.70710665f, 0.0f,   // ID 1
                                                                                                              0.0f, 0.0f, 0.70710665f, 0.70710665f,    // ID 2
                                                                                                             -0.707106471f, 0.707106471f, 0.0f, 0.0f}; // ID 3
