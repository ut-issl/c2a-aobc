...
const float ORBIT_PARAMETERS_kepler_inclination_rad = PHYSICAL_CONST_degree_to_radian(97.50372f);
const float ORBIT_PARAMETERS_kepler_raan_rad = PHYSICAL_CONST_degree_to_radian(340.20189f);
const float ORBIT_PARAMETERS_kepler_arg_perigee_rad = PHYSICAL_CONST_degree_to_radian(221.60537f);
...
const float ORBIT_PARAMETERS_gpsr_inclination_rad = PHYSICAL_CONST_degree_to_radian(97.50372f);
const float ORBIT_PARAMETERS_gpsr_raan_rad = PHYSICAL_CONST_degree_to_radian(340.20189f);
const float ORBIT_PARAMETERS_gpsr_arg_perigee_rad = PHYSICAL_CONST_degree_to_radian(0.0f);
...
const float ORBIT_PARAMETERS_gpsr_threshold_inclination_rad = PHYSICAL_CONST_degree_to_radian(20.0f);
const float ORBIT_PARAMETERS_gpsr_threshold_raan_rad = PHYSICAL_CONST_degree_to_radian(20.0f);
const float ORBIT_PARAMETERS_gpsr_threshold_arg_perigee_rad = PHYSICAL_CONST_degree_to_radian(50.0f);
