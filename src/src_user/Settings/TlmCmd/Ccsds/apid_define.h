...
typedef enum
{
  ...
  APID_TCAL_TLM = 0x410,    //!< 10000010000b: APID for TIME CARIBLATION TLM (TODO_L: 現在まともに使ってない)
  ...
  APID_DUMP_TLM = 0x710,    //!< 11100010000b: APID for DUMP TLM (TODO_L: 現在まともに使ってない)
