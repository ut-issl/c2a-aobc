/**
* @file   di_cubewheel.h
* @brief  CUBEWHEELÇÃDriver Instance
*/
...
/**
 * @brief  CUBEWHEELíËä˙é¿çsÉAÉvÉäê∂ê¨ä÷êî
 * @param  void
 * @return AppInfo
 */
AppInfo DI_CUBEWHEEL_update(void);

CCP_EXEC_STS Cmd_DI_CUBEWHEEL_Enable(const CTCP *packet);//ãå RW_startup
CCP_EXEC_STS Cmd_DI_CUBEWHEEL_Init(const CTCP* packet);//ãå RW_startup+enable
