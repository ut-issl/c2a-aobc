...
static void DI_INA260_init_(void)
{
  INA260_init(&ina260_driver_[INA260_IDX_PIC],          PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_PIC);
  INA260_init(&ina260_driver_[INA260_IDX_STIM210],      PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_STIM);
  INA260_init(&ina260_driver_[INA260_IDX_SAGITTA],      PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_SAGITTA);
  INA260_init(&ina260_driver_[INA260_IDX_OEM7600],      PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_OEM);
  INA260_init(&ina260_driver_[INA260_IDX_RM3100],       PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_RM);
  INA260_init(&ina260_driver_[INA260_IDX_NANOSSOC_D60], PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_SS);
  INA260_init(&ina260_driver_[INA260_IDX_MTQ],          PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_MTQ);
  INA260_init(&ina260_driver_[INA260_IDX_RW0003_X],     PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_RWX);
  INA260_init(&ina260_driver_[INA260_IDX_RW0003_Y],     PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_RWY);
  INA260_init(&ina260_driver_[INA260_IDX_RW0003_Z],     PORT_CH_I2C_INAS, I2C_DEVICE_ADDR_INA_RWZ);
