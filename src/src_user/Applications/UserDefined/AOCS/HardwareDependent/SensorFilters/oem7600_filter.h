...
typedef struct
{
  ...
  SpikeFilter_Config gps_time_total_msec_spike_filter_config;                  //!<  スパイク除去フィルタ設定パラメータ for 受信機時刻通算ミリ秒
  ...
  C2A_MATH_ERROR gps_time_total_msec_filter_error;                        //!< スパイク除去フィルタ入力判定ログ for 受信機時刻通算ミリ秒
} Oem7600Filter;
