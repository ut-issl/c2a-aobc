...
typedef struct
{
  ...
  SpikeFilter_Config gpstime_total_msec_spike_filter_config;                  //!<  スパイク除去フィルタ設定パラメータ for 受信機時刻通算ミリ秒
  ...
  GpsTime gpstime_filtered;                                          //!< フィルタリング後の受信機時刻
  ObcTime obct_gpstime_observed_filtered;                            //!< フィルタリング後の受信機時刻取得時OBCT
  ...
  C2A_MATH_ERROR gpstime_total_msec_filter_error;                        //!< スパイク除去フィルタ入力判定ログ for 受信機時刻通算ミリ秒
} Oem7600Filter;
