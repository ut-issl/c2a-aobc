...
typedef enum
{
  ...
  Cmd_CODE_DI_STIM210_INIT = 0x0078,
  Cmd_CODE_DI_STIM210_SET_MODE = 0x0079,
  Cmd_CODE_DI_STIM210_SET_NORMAL_MODE_FORMAT = 0x007A,
  Cmd_CODE_DI_STIM210_SET_GYRO_OUTPUT = 0x007B,
  Cmd_CODE_DI_STIM210_SET_SAMPLE_RATE = 0x007C,
  Cmd_CODE_DI_STIM210_SET_TERMINATION_MODE = 0x007D,
  Cmd_CODE_DI_STIM210_SET_LOW_PASS_FILTER = 0x007E,
  Cmd_CODE_DI_OEM7600_ONOFF_ANTENNA_POWER = 0x007F,
  Cmd_CODE_DI_OEM7600_SOFTWARE_RESET = 0x0080,
  Cmd_CODE_DI_OEM7600_SET_TLM_CONTENTS = 0x0081,
  Cmd_CODE_DI_OEM7600_SET_RESET_GPIO_HIGHLOW = 0x0082,
  Cmd_CODE_DI_RW0003_INIT = 0x0083,
  Cmd_CODE_DI_RW0003_SET_IDLE = 0x0084,
  Cmd_CODE_DI_RW0003_DRIVE_TORQUE = 0x0085,
  Cmd_CODE_DI_RW0003_DRIVE_SPEED = 0x0086,
  Cmd_CODE_DI_SAGITTA_BOOT = 0x0087,
  Cmd_CODE_DI_SAGITTA_SET_UNIX_TIME_US = 0x0088,
  Cmd_CODE_DI_SAGITTA_SET_PARAMETER = 0x0089,
  Cmd_CODE_DI_SAGITTA_CHANGE_PARAMETER = 0x008A,
  Cmd_CODE_DI_SAGITTA_READ_PARAMETER = 0x008B,
  Cmd_CODE_DI_RM3100_SET_FRAME_TRANSFORMATION_QUATERNION_C2B = 0x008C,
  Cmd_CODE_DI_MPU9250_SET_FRAME_TRANSFORMATION_QUATERNION_C2B = 0x008D,
  Cmd_CODE_DI_NANOSSOC_D60_SET_FRAME_TRANSFORMATION_QUATERNION_C2B = 0x008E,
  Cmd_CODE_DI_STIM210_SET_FRAME_TRANSFORMATION_QUATERNION_C2B = 0x008F,
  Cmd_CODE_DI_SAGITTA_SET_FRAME_TRANSFORMATION_QUATERNION_C2B = 0x0090,
  Cmd_CODE_DI_RW0003_SET_ROTATION_DIRECTION_VECTOR = 0x0091,
  Cmd_CODE_DI_MTQ_SEIREN_SET_MAGNETIC_MOMENT_DIRECTION_VECTOR = 0x0092,
  Cmd_CODE_DI_MPU9250_SET_ANG_VEL_BIAS_COMPO_RAD_S = 0x0093,
  Cmd_CODE_DI_MPU9250_SET_MAG_BIAS_COMPO_NT = 0x0094,
  Cmd_CODE_DI_RM3100_SET_MAG_BIAS_COMPO_NT = 0x0095,
  Cmd_CODE_DI_STIM210_SET_ANG_VEL_BIAS_COMPO_RAD_S = 0x0096,
  Cmd_CODE_DI_MPU9250_SET_ANG_VEL_BIAS_TEMP_CALIB = 0x0097,
  Cmd_CODE_DI_MPU9250_SET_ANG_VEL_SF_TEMP_CALIB = 0x0098,
  Cmd_CODE_DI_STIM210_SET_ANG_VEL_BIAS_TEMP_CALIB = 0x0099,
  Cmd_CODE_DI_STIM210_SET_ANG_VEL_SF_TEMP_CALIB = 0x009A,
  Cmd_CODE_APP_MAG_SELECTOR_SET_STATE = 0x009B,
  Cmd_CODE_APP_GYRO_SELECTOR_SET_STATE = 0x009C,
  Cmd_CODE_SUN_SENSOR_SELECTOR_SET_INTENSITY_THRESHOLD = 0x009D,
  Cmd_CODE_APP_TEMPERATURE_ANOMALY_SET_THRESHOLD = 0x009E,
