...
static TF_TLM_FUNC_ACK Tlm_AOBC_SAGITTA_SET2_(uint8_t* packet, uint16_t* len, uint16_t max_len)
{
  ...
  TF_copy_u64(&packet[188], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.set_parameter.blob_filter.max_oflow));
  TF_copy_u64(&packet[196], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.set_parameter.blob_filter.max_open));
  TF_copy_u64(&packet[204], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.set_parameter.blob_filter.max_simopen));
  TF_copy_u64(&packet[212], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.set_parameter.blob_filter.max_valid));
  TF_copy_u64(&packet[220], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.set_parameter.blob_filter.desired));
...
static TF_TLM_FUNC_ACK Tlm_AOBC_SAGITTA_READ2_(uint8_t* packet, uint16_t* len, uint16_t max_len)
{
  ...
  TF_copy_u64(&packet[188], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.read_parameter.blob_filter.max_oflow));
  TF_copy_u64(&packet[196], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.read_parameter.blob_filter.max_open));
  TF_copy_u64(&packet[204], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.read_parameter.blob_filter.max_simopen));
  TF_copy_u64(&packet[212], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.read_parameter.blob_filter.max_valid));
  TF_copy_u64(&packet[220], (uint64_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.read_parameter.blob_filter.desired));
