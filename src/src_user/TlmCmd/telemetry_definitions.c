...
static TF_TLM_FUNC_ACK Tlm_AOBC_OBC_(uint8_t* packet, uint16_t* len, uint16_t max_len)
{
  ...
  TF_copy_u8(&packet[33], (uint8_t)(TDSP_info->task_list_id));
  TF_copy_u32(&packet[34], (uint32_t)(TDSP_info->tskd.prev_err.time.total_cycle));
  TF_copy_u8(&packet[38], (uint8_t)(TDSP_info->tskd.prev_err.time.step));
  TF_copy_u16(&packet[39], (uint16_t)(TDSP_info->tskd.prev_err.code));
  TF_copy_i8(&packet[41], (int8_t)(TDSP_info->tskd.prev_err.sts));
  TF_copy_u32(&packet[42], PH_gs_cmd_list.executed_nodes_);
  ...
  TF_copy_u32(&packet[53], (uint32_t)(gs_command_dispatcher->prev_err.time.total_cycle));
  ...
  TF_copy_u32(&packet[60], (uint32_t)(gs_command_dispatcher->error_counter));
  TF_copy_u32(&packet[64], PH_rt_cmd_list.executed_nodes_);
  TF_copy_u32(&packet[68], (uint32_t)(realtime_command_dispatcher->prev.time.total_cycle));
  TF_copy_u16(&packet[72], (uint16_t)(realtime_command_dispatcher->prev.code));
  TF_copy_i8(&packet[74], (int8_t)(realtime_command_dispatcher->prev.sts));
  TF_copy_u32(&packet[75], (uint32_t)(realtime_command_dispatcher->prev_err.time.total_cycle));
  TF_copy_u16(&packet[79], (uint16_t)(realtime_command_dispatcher->prev_err.code));
  TF_copy_i8(&packet[81], (int8_t)(realtime_command_dispatcher->prev_err.sts));
  TF_copy_u32(&packet[82], (uint32_t)(realtime_command_dispatcher->error_counter));
  TF_copy_u32(&packet[86], PH_tl_cmd_list[TLCD_ID_FROM_GS].executed_nodes_);
  TF_copy_u8(&packet[90], (uint8_t)(PH_tl_cmd_list[TLCD_ID_FROM_GS].active_nodes_));
  TF_copy_u32(&packet[91], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev.time.total_cycle));
  TF_copy_u16(&packet[95], (uint16_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev.code));
  TF_copy_i8(&packet[97], (int8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev.sts));
  TF_copy_u32(&packet[98], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev_err.time.total_cycle));
  TF_copy_u16(&packet[102], (uint16_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev_err.code));
  TF_copy_i8(&packet[104], (int8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev_err.sts));
  TF_copy_u32(&packet[105], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].error_counter));
  TF_copy_u8(&packet[109], (uint8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].stop_on_error));
  TF_copy_u8(&packet[110], (uint8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].lockout));
  TF_copy_u32(&packet[111], (PL_is_empty(&(PH_tl_cmd_list[TLCD_ID_FROM_GS])) ? 0 : CCP_get_ti((const CommonCmdPacket*)(PL_get_head(&(PH_tl_cmd_list[TLCD_ID_FROM_GS]))->packet))));
  TF_copy_u16(&packet[115], (uint16_t)(PL_is_empty(&(PH_tl_cmd_list[TLCD_ID_FROM_GS])) ? 0 : CCP_get_id((const CommonCmdPacket*)(PL_get_head(&(PH_tl_cmd_list[TLCD_ID_FROM_GS]))->packet))));
  TF_copy_u32(&packet[117], PH_tl_cmd_list[TLCD_ID_DEPLOY_BC].executed_nodes_);
  TF_copy_u8(&packet[121], (uint8_t)(PH_tl_cmd_list[TLCD_ID_DEPLOY_BC].active_nodes_));
  TF_copy_u32(&packet[122], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].prev.time.total_cycle));
  TF_copy_u16(&packet[126], (uint16_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].prev.code));
  TF_copy_i8(&packet[128], (int8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].prev.sts));
  TF_copy_u32(&packet[129], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].prev_err.time.total_cycle));
  TF_copy_u16(&packet[133], (uint16_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].prev_err.code));
  TF_copy_i8(&packet[135], (int8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].prev_err.sts));
  TF_copy_u32(&packet[136], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].error_counter));
  TF_copy_u8(&packet[140], (uint8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].stop_on_error));
  TF_copy_u8(&packet[141], (uint8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].lockout));
  TF_copy_u32(&packet[142], (PL_is_empty(&(PH_tl_cmd_list[TLCD_ID_DEPLOY_BC])) ? 0 : CCP_get_ti((const CommonCmdPacket*)(PL_get_head(&(PH_tl_cmd_list[TLCD_ID_DEPLOY_BC]))->packet))));
  TF_copy_u16(&packet[146], (uint16_t)(PL_is_empty(&(PH_tl_cmd_list[TLCD_ID_DEPLOY_BC])) ? 0 : CCP_get_id((const CommonCmdPacket*)(PL_get_head(&(PH_tl_cmd_list[TLCD_ID_DEPLOY_BC]))->packet))));
  TF_copy_u32(&packet[148], PH_tl_cmd_list[TLCD_ID_DEPLOY_TLM].executed_nodes_);
  TF_copy_u8(&packet[152], (uint8_t)(PH_tl_cmd_list[TLCD_ID_DEPLOY_TLM].active_nodes_));
  TF_copy_u32(&packet[153], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].prev.time.total_cycle));
  TF_copy_u16(&packet[157], (uint16_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].prev.code));
  TF_copy_i8(&packet[159], (int8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].prev.sts));
  TF_copy_u32(&packet[160], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].prev_err.time.total_cycle));
  TF_copy_u16(&packet[164], (uint16_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].prev_err.code));
  TF_copy_i8(&packet[166], (int8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].prev_err.sts));
  TF_copy_u32(&packet[167], (uint32_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].error_counter));
  TF_copy_u8(&packet[171], (uint8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].stop_on_error));
  TF_copy_u8(&packet[172], (uint8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].lockout));
  TF_copy_u32(&packet[173], (PL_is_empty(&(PH_tl_cmd_list[TLCD_ID_DEPLOY_TLM])) ? 0 : CCP_get_ti((const CommonCmdPacket*)(PL_get_head(&(PH_tl_cmd_list[TLCD_ID_DEPLOY_TLM]))->packet))));
  TF_copy_u16(&packet[177], (uint16_t)(PL_is_empty(&(PH_tl_cmd_list[TLCD_ID_DEPLOY_TLM])) ? 0 : CCP_get_id((const CommonCmdPacket*)(PL_get_head(&(PH_tl_cmd_list[TLCD_ID_DEPLOY_TLM]))->packet))));
  TF_copy_u8(&packet[179], (uint8_t)(block_command_table->pos.block));
  TF_copy_u8(&packet[180], (uint8_t)(block_command_table->pos.cmd));
  TF_copy_u32(&packet[181], ((block_command_table->pos.cmd == 0) ? 0 : (uint32_t)BCT_get_ti(block_command_table->pos.block, (uint8_t)(block_command_table->pos.cmd-1))));
  TF_copy_u16(&packet[185], (uint16_t)((block_command_table->pos.cmd == 0) ? 0 : BCT_get_id(block_command_table->pos.block, (uint8_t)(block_command_table->pos.cmd-1))));
  TF_copy_u32(&packet[187], PH_ms_tlm_list.executed_nodes_);
  TF_copy_u8(&packet[191], (uint8_t)(PH_ms_tlm_list.active_nodes_));
#endif
...
static TF_TLM_FUNC_ACK Tlm_AOBC_HK_GEN_(uint8_t* packet, uint16_t* len, uint16_t max_len)
{
  ...
  TF_copy_u16(&packet[32], TDSP_info->task_list_id);
  ...
  TF_copy_i8(&packet[41], (int8_t)(gs_command_dispatcher->prev.sts));
  ...
  TF_copy_i8(&packet[49], (int8_t)(gs_command_dispatcher->prev_err.sts));
  TF_copy_u8(&packet[50], (uint8_t)(PH_tl_cmd_list[TLCD_ID_FROM_GS].executed_nodes_));
  TF_copy_u8(&packet[51], (uint8_t)(PH_tl_cmd_list[TLCD_ID_FROM_GS].active_nodes_));
  TF_copy_u32(&packet[52], (uint32_t)timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev.time.total_cycle);
  TF_copy_u16(&packet[56], (uint16_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev.code));
  TF_copy_i8(&packet[58], (int8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev.sts));
  TF_copy_u32(&packet[59], (uint32_t)timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev_err.time.total_cycle);
  TF_copy_u16(&packet[63], (uint16_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev_err.code));
  TF_copy_i8(&packet[65], (int8_t)(timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].prev_err.sts));
  TF_copy_u32(&packet[66], (PL_is_empty(&(PH_tl_cmd_list[TLCD_ID_FROM_GS])) ? 0 : CCP_get_ti((const CommonCmdPacket*)(PL_get_head(&(PH_tl_cmd_list[TLCD_ID_FROM_GS]))->packet))));
  TF_copy_u16(&packet[70], (uint16_t)(PL_is_empty(&(PH_tl_cmd_list[TLCD_ID_FROM_GS])) ? 0 : CCP_get_id((const CommonCmdPacket*)(PL_get_head(&(PH_tl_cmd_list[TLCD_ID_FROM_GS]))->packet))));
  TF_copy_u8(&packet[72], (uint8_t)(((uint8_t)timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].stop_on_error << 7 & 0x80) | ((uint8_t)timeline_command_dispatcher->dispatcher[TLCD_ID_FROM_GS].lockout << 6 & 0x40) | ((uint8_t)timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].stop_on_error << 5 & 0x20) | ((uint8_t)timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_BC].lockout << 4 & 0x10) | ((uint8_t)timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].stop_on_error << 3 & 0x08) | ((uint8_t)timeline_command_dispatcher->dispatcher[TLCD_ID_DEPLOY_TLM].lockout << 2 & 0x04) | (0 << 2 & 0x02) | (0 << 2 & 0x01) ));
  TF_copy_u16(&packet[73], block_command_table->pos.block);
  TF_copy_u8(&packet[75], (uint8_t)(block_command_table->pos.cmd));
  TF_copy_u32(&packet[76], ((block_command_table->pos.cmd == 0) ? 0 : (uint32_t)BCT_get_ti(block_command_table->pos.block, (uint8_t)(block_command_table->pos.cmd-1))));
  TF_copy_u16(&packet[80], (uint16_t)((block_command_table->pos.cmd == 0) ? 0 : BCT_get_id(block_command_table->pos.block, (uint8_t)(block_command_table->pos.cmd-1))));
  TF_copy_u8(&packet[82], (uint8_t)(PH_tl_cmd_list[TLCD_ID_DEPLOY_BC].executed_nodes_));
  TF_copy_u8(&packet[83], (uint8_t)(PH_tl_cmd_list[TLCD_ID_DEPLOY_BC].active_nodes_));
  TF_copy_u8(&packet[84], (uint8_t)(PH_tl_cmd_list[TLCD_ID_DEPLOY_TLM].executed_nodes_));
  TF_copy_u8(&packet[85], (uint8_t)(PH_tl_cmd_list[TLCD_ID_DEPLOY_TLM].active_nodes_));
  TF_copy_u32(&packet[86], event_logger->statistics.record_counter_total);
  TF_copy_u16(&packet[90], (uint16_t)event_logger->statistics.record_counters[EL_ERROR_LEVEL_HIGH]);
  TF_copy_u16(&packet[92], (uint16_t)event_logger->statistics.record_counters[EL_ERROR_LEVEL_LOW]);
  TF_copy_u16(&packet[94], (uint16_t)event_logger->statistics.record_counters[EL_ERROR_LEVEL_EL]);
  TF_copy_u16(&packet[96], (uint16_t)event_logger->statistics.record_counters[EL_ERROR_LEVEL_EH]);
  TF_copy_u8(&packet[98], (uint8_t)event_logger->latest_event.group);
  TF_copy_u32(&packet[99], event_logger->latest_event.local);
  TF_copy_u8(&packet[103], (uint8_t)event_logger->latest_event.err_level);
  TF_copy_u32(&packet[104], event_logger->latest_event.time.total_cycle);
  TF_copy_u8(&packet[108], (uint8_t)event_logger->latest_event.time.step);
  ...
  TF_copy_u8(&packet[127], (uint8_t)(power_switch_control->switch_state_5v_tlm.byte));
  TF_copy_u8(&packet[128], (uint8_t)(power_switch_control->switch_state_unreg_tlm.byte));
  TF_copy_i16(&packet[129], (int16_t)(ina260_driver[INA260_IDX_PIC]->info.current_raw));
  TF_copy_u16(&packet[131], (uint16_t)(ina260_driver[INA260_IDX_PIC]->info.voltage_raw));
  TF_copy_u16(&packet[133], (uint16_t)(ina260_driver[INA260_IDX_PIC]->info.oc_threshold_raw));
  TF_copy_i16(&packet[135], (int16_t)(ina260_driver[INA260_IDX_STIM210]->info.current_raw));
  TF_copy_u16(&packet[137], (uint16_t)(ina260_driver[INA260_IDX_STIM210]->info.voltage_raw));
  TF_copy_u16(&packet[139], (uint16_t)(ina260_driver[INA260_IDX_STIM210]->info.oc_threshold_raw));
  TF_copy_i16(&packet[141], (int16_t)(ina260_driver[INA260_IDX_SAGITTA]->info.current_raw));
  TF_copy_u16(&packet[143], (uint16_t)(ina260_driver[INA260_IDX_SAGITTA]->info.voltage_raw));
  TF_copy_u16(&packet[145], (uint16_t)(ina260_driver[INA260_IDX_SAGITTA]->info.oc_threshold_raw));
  TF_copy_i16(&packet[147], (int16_t)(ina260_driver[INA260_IDX_OEM7600]->info.current_raw));
  TF_copy_u16(&packet[149], (uint16_t)(ina260_driver[INA260_IDX_OEM7600]->info.voltage_raw));
  TF_copy_u16(&packet[151], (uint16_t)(ina260_driver[INA260_IDX_OEM7600]->info.oc_threshold_raw));
  TF_copy_i16(&packet[153], (int16_t)(ina260_driver[INA260_IDX_RM3100]->info.current_raw));
  TF_copy_u16(&packet[155], (uint16_t)(ina260_driver[INA260_IDX_RM3100]->info.voltage_raw));
  TF_copy_u16(&packet[157], (uint16_t)(ina260_driver[INA260_IDX_RM3100]->info.oc_threshold_raw));
  TF_copy_i16(&packet[159], (int16_t)(ina260_driver[INA260_IDX_NANOSSOC_D60]->info.current_raw));
  TF_copy_u16(&packet[161], (uint16_t)(ina260_driver[INA260_IDX_NANOSSOC_D60]->info.voltage_raw));
  TF_copy_u16(&packet[163], (uint16_t)(ina260_driver[INA260_IDX_NANOSSOC_D60]->info.oc_threshold_raw));
  TF_copy_i16(&packet[165], (int16_t)(ina260_driver[INA260_IDX_MTQ]->info.current_raw));
  TF_copy_u16(&packet[167], (uint16_t)(ina260_driver[INA260_IDX_MTQ]->info.voltage_raw));
  TF_copy_u16(&packet[169], (uint16_t)(ina260_driver[INA260_IDX_MTQ]->info.oc_threshold_raw));
  TF_copy_i16(&packet[171], (int16_t)(ina260_driver[INA260_IDX_RW0003_X]->info.current_raw));
  TF_copy_u16(&packet[173], (uint16_t)(ina260_driver[INA260_IDX_RW0003_X]->info.voltage_raw));
  TF_copy_u16(&packet[175], (uint16_t)(ina260_driver[INA260_IDX_RW0003_X]->info.oc_threshold_raw));
  TF_copy_i16(&packet[177], (int16_t)(ina260_driver[INA260_IDX_RW0003_Y]->info.current_raw));
  TF_copy_u16(&packet[179], (uint16_t)(ina260_driver[INA260_IDX_RW0003_Y]->info.voltage_raw));
  TF_copy_u16(&packet[181], (uint16_t)(ina260_driver[INA260_IDX_RW0003_Y]->info.oc_threshold_raw));
  TF_copy_i16(&packet[183], (int16_t)(ina260_driver[INA260_IDX_RW0003_Z]->info.current_raw));
  TF_copy_u16(&packet[185], (uint16_t)(ina260_driver[INA260_IDX_RW0003_Z]->info.voltage_raw));
  TF_copy_u16(&packet[187], (uint16_t)(ina260_driver[INA260_IDX_RW0003_Z]->info.oc_threshold_raw));
  TF_copy_float(&packet[189], (float)(thermo_sensor->temperature_degC[APP_TSNS_IDX_PIC]));
  TF_copy_float(&packet[193], (float)(thermo_sensor->temperature_degC[APP_TSNS_IDX_RW_DCDC]));
  TF_copy_float(&packet[197], (float)(mpu9250_driver[MPU9250_IDX_ON_AOBC]->info.temperature_degC));
  TF_copy_float(&packet[201], (float)(stim210_driver[STIM210_IDX_IN_UNIT]->info.temperature_compo_degC[0]));
  TF_copy_float(&packet[205], (float)(stim210_driver[STIM210_IDX_IN_UNIT]->info.temperature_compo_degC[1]));
  TF_copy_float(&packet[209], (float)(stim210_driver[STIM210_IDX_IN_UNIT]->info.temperature_compo_degC[2]));
  TF_copy_float(&packet[213], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.temperature_mcu_degC));
  TF_copy_float(&packet[217], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.temperature_fpga_degC));
  TF_copy_float(&packet[221], (float)(rw0003_driver[RW0003_IDX_ON_X]->info.temperature_degC));
  TF_copy_float(&packet[225], (float)(rw0003_driver[RW0003_IDX_ON_Y]->info.temperature_degC));
  TF_copy_float(&packet[229], (float)(rw0003_driver[RW0003_IDX_ON_Z]->info.temperature_degC));
  TF_copy_float(&packet[233], (float)(oem7600_driver[OEM7600_IDX_IN_UNIT]->info.hardware_status.temperature_degC));
#endif
