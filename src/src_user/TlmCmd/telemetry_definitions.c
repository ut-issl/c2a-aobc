...
static TF_TLM_FUNC_ACK Tlm_AOBC_HK_GEN_(uint8_t* packet, uint16_t* len, uint16_t max_len)
{
  if (227 > max_len) return TF_TLM_FUNC_ACK_TOO_SHORT_LEN;
  ...
  TF_copy_u8(&packet[133], (uint8_t)(power_switch_control->switch_state_5v_tlm.byte));
  TF_copy_u8(&packet[134], (uint8_t)(power_switch_control->switch_state_unreg_tlm.byte));
  TF_copy_i16(&packet[135], (int16_t)(ina260_driver[INA260_IDX_PIC]->info.current_raw));
  TF_copy_u16(&packet[137], (uint16_t)(ina260_driver[INA260_IDX_PIC]->info.voltage_raw));
  TF_copy_i16(&packet[139], (int16_t)(ina260_driver[INA260_IDX_STIM210]->info.current_raw));
  TF_copy_u16(&packet[141], (uint16_t)(ina260_driver[INA260_IDX_STIM210]->info.voltage_raw));
  TF_copy_i16(&packet[143], (int16_t)(ina260_driver[INA260_IDX_SAGITTA]->info.current_raw));
  TF_copy_u16(&packet[145], (uint16_t)(ina260_driver[INA260_IDX_SAGITTA]->info.voltage_raw));
  ...
  TF_copy_i16(&packet[151], (int16_t)(ina260_driver[INA260_IDX_RM3100]->info.current_raw));
  TF_copy_u16(&packet[153], (uint16_t)(ina260_driver[INA260_IDX_RM3100]->info.voltage_raw));
  TF_copy_i16(&packet[155], (int16_t)(ina260_driver[INA260_IDX_NANOSSOC_D60]->info.current_raw));
  TF_copy_u16(&packet[157], (uint16_t)(ina260_driver[INA260_IDX_NANOSSOC_D60]->info.voltage_raw));
  TF_copy_i16(&packet[159], (int16_t)(ina260_driver[INA260_IDX_MTQ]->info.current_raw));
  TF_copy_u16(&packet[161], (uint16_t)(ina260_driver[INA260_IDX_MTQ]->info.voltage_raw));
  TF_copy_i16(&packet[163], (int16_t)(ina260_driver[INA260_IDX_RW0003_X]->info.current_raw));
  TF_copy_u16(&packet[165], (uint16_t)(ina260_driver[INA260_IDX_RW0003_X]->info.voltage_raw));
  TF_copy_i16(&packet[167], (int16_t)(ina260_driver[INA260_IDX_RW0003_Y]->info.current_raw));
  TF_copy_u16(&packet[169], (uint16_t)(ina260_driver[INA260_IDX_RW0003_Y]->info.voltage_raw));
  TF_copy_i16(&packet[171], (int16_t)(ina260_driver[INA260_IDX_RW0003_Z]->info.current_raw));
  TF_copy_u16(&packet[173], (uint16_t)(ina260_driver[INA260_IDX_RW0003_Z]->info.voltage_raw));
  TF_copy_float(&packet[175], (float)(thermo_sensor->temperature_degC[APP_TSNS_IDX_PIC]));
  TF_copy_float(&packet[179], (float)(thermo_sensor->temperature_degC[APP_TSNS_IDX_RW_DCDC]));
  TF_copy_float(&packet[183], (float)(mpu9250_driver[MPU9250_IDX_ON_AOBC]->info.temperature_degC));
  TF_copy_float(&packet[187], (float)(stim210_driver[STIM210_IDX_IN_UNIT]->info.temperature_compo_degC[0]));
  TF_copy_float(&packet[191], (float)(stim210_driver[STIM210_IDX_IN_UNIT]->info.temperature_compo_degC[1]));
  TF_copy_float(&packet[195], (float)(stim210_driver[STIM210_IDX_IN_UNIT]->info.temperature_compo_degC[2]));
  TF_copy_float(&packet[199], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.temperature.mcu_degC));
  TF_copy_float(&packet[203], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.temperature.fpga_degC));
  TF_copy_float(&packet[207], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.temperature.cmos_degC));
  TF_copy_float(&packet[211], (float)(rw0003_driver[RW0003_IDX_ON_X]->info.temperature_degC));
  TF_copy_float(&packet[215], (float)(rw0003_driver[RW0003_IDX_ON_Y]->info.temperature_degC));
  TF_copy_float(&packet[219], (float)(rw0003_driver[RW0003_IDX_ON_Z]->info.temperature_degC));
  TF_copy_float(&packet[223], (float)(oem7600_driver[OEM7600_IDX_IN_UNIT]->info.hardware_status.temperature_degC));
#endif
...
static TF_TLM_FUNC_ACK Tlm_AOBC_CONTROL_(uint8_t* packet, uint16_t* len, uint16_t max_len)
{
  if (239 > max_len) return TF_TLM_FUNC_ACK_TOO_SHORT_LEN;
  ...
  TF_copy_u8(&packet[43], (uint8_t)(gyro_selector->state));
  TF_copy_float(&packet[44], (float)(sun_sensor_selector->sun_intensity_upper_threshold_percent));
  TF_copy_float(&packet[48], (float)(sun_sensor_selector->sun_intensity_lower_threshold_percent));
  TF_copy_u8(&packet[52], (uint8_t)(rough_three_axis_determination->method));
  TF_copy_u8(&packet[53], (uint8_t)(rough_three_axis_determination->sun_invisible_propagation));
  TF_copy_float(&packet[54], (float)(rough_three_axis_determination->q_method_info.sun_vec_weight));
  TF_copy_float(&packet[58], (float)(rough_three_axis_determination->q_method_info.mag_vec_weight));
  TF_copy_u8(&packet[62], (uint8_t)(fine_three_axis_determination->method));
  TF_copy_float(&packet[63], (float)(aocs_manager->ang_vel_error_body_rad_s[0]));
  TF_copy_float(&packet[67], (float)(aocs_manager->ang_vel_error_body_rad_s[1]));
  TF_copy_float(&packet[71], (float)(aocs_manager->ang_vel_error_body_rad_s[2]));
  TF_copy_float(&packet[75], (float)(aocs_manager->quaternion_error_b2t.vector_part[0]));
  TF_copy_float(&packet[79], (float)(aocs_manager->quaternion_error_b2t.vector_part[1]));
  TF_copy_float(&packet[83], (float)(aocs_manager->quaternion_error_b2t.vector_part[2]));
  TF_copy_float(&packet[87], (float)(aocs_manager->quaternion_error_b2t.scalar_part));
  TF_copy_float(&packet[91], (float)(aocs_manager->sun_vec_error_rad));
  TF_copy_float(&packet[95], (float)(unloading->control_gain));
  TF_copy_u8(&packet[99], (uint8_t)(unloading->exec_is_enable));
  TF_copy_float(&packet[100], (float)(unloading->angular_velocity_upper_threshold_rad_s[0]));
  TF_copy_float(&packet[104], (float)(unloading->angular_velocity_target_rad_s[0]));
  TF_copy_float(&packet[108], (float)(unloading->angular_velocity_lower_threshold_rad_s[0]));
  TF_copy_float(&packet[112], (float)(unloading->angular_velocity_upper_threshold_rad_s[1]));
  TF_copy_float(&packet[116], (float)(unloading->angular_velocity_target_rad_s[1]));
  TF_copy_float(&packet[120], (float)(unloading->angular_velocity_lower_threshold_rad_s[1]));
  TF_copy_float(&packet[124], (float)(unloading->angular_velocity_upper_threshold_rad_s[2]));
  TF_copy_float(&packet[128], (float)(unloading->angular_velocity_target_rad_s[2]));
  TF_copy_float(&packet[132], (float)(unloading->angular_velocity_lower_threshold_rad_s[2]));
  TF_copy_u8(&packet[136], (uint8_t)(target_attitude_calculator->mode));
  TF_copy_u8(&packet[137], (uint8_t)(target_attitude_calculator->is_enabled));
  TF_copy_float(&packet[138], (float)(target_attitude_calculator->quaternion_target_i2t.vector_part[0]));
  TF_copy_float(&packet[142], (float)(target_attitude_calculator->quaternion_target_i2t.vector_part[1]));
  TF_copy_float(&packet[146], (float)(target_attitude_calculator->quaternion_target_i2t.vector_part[2]));
  TF_copy_float(&packet[150], (float)(target_attitude_calculator->quaternion_target_i2t.scalar_part));
  TF_copy_float(&packet[154], (float)(target_attitude_calculator->ang_vel_target_body_rad_s[0]));
  TF_copy_float(&packet[158], (float)(target_attitude_calculator->ang_vel_target_body_rad_s[1]));
  TF_copy_float(&packet[162], (float)(target_attitude_calculator->ang_vel_target_body_rad_s[2]));
  TF_copy_u8(&packet[166], (uint8_t)(target_attitude_from_orbit->main_target_direction));
  TF_copy_u8(&packet[167], (uint8_t)(target_attitude_from_orbit->sub_target_direction));
  TF_copy_float(&packet[168], (float)(target_attitude_from_orbit->vec_to_main_target_body[0]));
  TF_copy_float(&packet[172], (float)(target_attitude_from_orbit->vec_to_main_target_body[1]));
  TF_copy_float(&packet[176], (float)(target_attitude_from_orbit->vec_to_main_target_body[2]));
  TF_copy_float(&packet[180], (float)(target_attitude_from_orbit->vec_to_sub_target_body[0]));
  TF_copy_float(&packet[184], (float)(target_attitude_from_orbit->vec_to_sub_target_body[1]));
  TF_copy_float(&packet[188], (float)(target_attitude_from_orbit->vec_to_sub_target_body[2]));
  TF_copy_float(&packet[192], (float)(target_attitude_from_orbit->target_lla_rad_m[0]));
  TF_copy_float(&packet[196], (float)(target_attitude_from_orbit->target_lla_rad_m[1]));
  TF_copy_float(&packet[200], (float)(target_attitude_from_orbit->target_lla_rad_m[2]));
  TF_copy_u8(&packet[204], (uint8_t)(target_attitude_from_orbit->offset_angle_axis));
  TF_copy_float(&packet[205], (float)(target_attitude_from_orbit->offset_angle_rad));
  TF_copy_u8(&packet[209], (uint8_t)(quaternion_interpolator->current_target_num));
  TF_copy_u8(&packet[210], (uint8_t)(quaternion_interpolator->index));
  TF_copy_u32(&packet[211], (uint32_t)(quaternion_interpolator->previous_attitude_changed_ti));
  TF_copy_float(&packet[215], (float)(quaternion_interpolator->previous_quaternion_target_i2t.vector_part[0]));
  TF_copy_float(&packet[219], (float)(quaternion_interpolator->previous_quaternion_target_i2t.vector_part[1]));
  TF_copy_float(&packet[223], (float)(quaternion_interpolator->previous_quaternion_target_i2t.vector_part[2]));
  TF_copy_float(&packet[227], (float)(quaternion_interpolator->previous_quaternion_target_i2t.scalar_part));
  TF_copy_float(&packet[231], (float)(target_attitude_calculator->sampling_freq_Hz));
  TF_copy_float(&packet[235], (float)(target_attitude_calculator->cut_off_freq_lpf_1st_Hz));
#endif
...
#ifndef BUILD_SETTINGS_FAST_BUILD
  TF_copy_u8(&packet[26], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.version.program));
  TF_copy_u8(&packet[27], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.version.major));
  TF_copy_u8(&packet[28], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.version.minor));
  TF_copy_float(&packet[29], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.quaternion_i2c.vector_part[0]));
  TF_copy_float(&packet[33], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.quaternion_i2c.vector_part[1]));
  TF_copy_float(&packet[37], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.quaternion_i2c.vector_part[2]));
  TF_copy_float(&packet[41], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.quaternion_i2c.scalar_part));
  TF_copy_float(&packet[45], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.track_confidence));
  TF_copy_float(&packet[49], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.track_quaternion_i2c.vector_part[0]));
  TF_copy_float(&packet[53], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.track_quaternion_i2c.vector_part[1]));
  TF_copy_float(&packet[57], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.track_quaternion_i2c.vector_part[2]));
  TF_copy_float(&packet[61], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.track_quaternion_i2c.scalar_part));
  TF_copy_u8(&packet[65], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.num_stars_removed));
  TF_copy_u8(&packet[66], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.num_stars_centroided));
  TF_copy_u8(&packet[67], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.num_stars_matched));
  TF_copy_float(&packet[68], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.lisa_quaternion_i2c.vector_part[0]));
  TF_copy_float(&packet[72], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.lisa_quaternion_i2c.vector_part[1]));
  TF_copy_float(&packet[76], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.lisa_quaternion_i2c.vector_part[2]));
  TF_copy_float(&packet[80], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.lisa_quaternion_i2c.scalar_part));
  TF_copy_float(&packet[84], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.lisa_percentage_close));
  TF_copy_u8(&packet[88], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.num_stars_lisa_close));
  TF_copy_u8(&packet[89], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.star_tracker_mode));
  TF_copy_u8(&packet[90], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.is_valid_quaternion));
  TF_copy_u32(&packet[91], (uint32_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.stable_count));
  TF_copy_u8(&packet[95], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.solution.solution_strategy));
  TF_copy_u8(&packet[96], (uint8_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.count));
  TF_copy_u32(&packet[97], (uint32_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.id[0]));
  TF_copy_float(&packet[101], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.x_coordinate[0]));
  TF_copy_float(&packet[105], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.y_coordinate[0]));
  TF_copy_float(&packet[109], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_x_coordinate[0]));
  TF_copy_float(&packet[113], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_y_coordinate[0]));
  TF_copy_u32(&packet[117], (uint32_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.id[1]));
  TF_copy_float(&packet[121], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.x_coordinate[1]));
  TF_copy_float(&packet[125], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.y_coordinate[1]));
  TF_copy_float(&packet[129], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_x_coordinate[1]));
  TF_copy_float(&packet[133], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_y_coordinate[1]));
  TF_copy_u32(&packet[137], (uint32_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.id[2]));
  TF_copy_float(&packet[141], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.x_coordinate[2]));
  TF_copy_float(&packet[145], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.y_coordinate[2]));
  TF_copy_float(&packet[149], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_x_coordinate[2]));
  TF_copy_float(&packet[153], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_y_coordinate[2]));
  TF_copy_u32(&packet[157], (uint32_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.id[3]));
  TF_copy_float(&packet[161], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.x_coordinate[3]));
  TF_copy_float(&packet[165], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.y_coordinate[3]));
  TF_copy_float(&packet[169], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_x_coordinate[3]));
  TF_copy_float(&packet[173], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_y_coordinate[3]));
  TF_copy_u32(&packet[177], (uint32_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.id[4]));
  TF_copy_float(&packet[181], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.x_coordinate[4]));
  TF_copy_float(&packet[185], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.y_coordinate[4]));
  TF_copy_float(&packet[189], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_x_coordinate[4]));
  TF_copy_float(&packet[193], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_y_coordinate[4]));
  TF_copy_u32(&packet[197], (uint32_t)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.id[5]));
  TF_copy_float(&packet[201], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.x_coordinate[5]));
  TF_copy_float(&packet[205], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.y_coordinate[5]));
  TF_copy_float(&packet[209], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_x_coordinate[5]));
  TF_copy_float(&packet[213], (float)(sagitta_driver[SAGITTA_IDX_IN_UNIT]->info.telemetry.matched_centroids.error_y_coordinate[5]));
#endif
