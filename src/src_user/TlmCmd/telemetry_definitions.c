...
static TF_TLM_FUNC_ACK Tlm_AOBC_NON_VOLATILE_(uint8_t* packet, uint16_t* len, uint16_t max_len)
{
  ...
  TF_copy_u8(&packet[123], nv_bc_manager->is_active);
  TF_copy_u16(&packet[124], (uint16_t)nv_bc_manager->bc_id_to_copy);
  TF_copy_u8(&packet[126], nv_bc_manager->bc_num_to_copy);
  TF_copy_u32(&packet[127], nv_bc_manager->address_for_ready_flags);
  TF_copy_u32(&packet[131], nv_bc_manager->address_for_bc);
  TF_copy_u8(&packet[135], (uint8_t)((nv_bc_manager->is_ready_to_restore[0] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[1] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[2] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[3] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[4] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[5] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[6] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[7] & 0x01) ));
  TF_copy_u8(&packet[136], (uint8_t)((nv_bc_manager->is_ready_to_restore[8] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[9] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[10] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[11] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[12] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[13] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[14] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[15] & 0x01) ));
  TF_copy_u8(&packet[137], (uint8_t)((nv_bc_manager->is_ready_to_restore[16] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[17] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[18] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[19] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[20] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[21] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[22] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[23] & 0x01) ));
  TF_copy_u8(&packet[138], (uint8_t)((nv_bc_manager->is_ready_to_restore[24] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[25] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[26] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[27] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[28] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[29] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[30] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[31] & 0x01) ));
  TF_copy_u8(&packet[139], (uint8_t)((nv_bc_manager->is_ready_to_restore[32] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[33] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[34] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[35] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[36] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[37] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[38] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[39] & 0x01) ));
  TF_copy_u8(&packet[140], (uint8_t)((nv_bc_manager->is_ready_to_restore[40] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[41] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[42] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[43] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[44] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[45] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[46] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[47] & 0x01) ));
  TF_copy_u8(&packet[141], (uint8_t)((nv_bc_manager->is_ready_to_restore[48] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[49] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[50] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[51] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[52] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[53] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[54] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[55] & 0x01) ));
  TF_copy_u8(&packet[142], (uint8_t)((nv_bc_manager->is_ready_to_restore[56] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[57] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[58] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[59] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[60] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[61] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[62] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[63] & 0x01) ));
  TF_copy_u8(&packet[143], (uint8_t)((nv_bc_manager->is_ready_to_restore[64] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[65] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[66] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[67] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[68] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[69] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[70] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[71] & 0x01) ));
  TF_copy_u8(&packet[144], (uint8_t)((nv_bc_manager->is_ready_to_restore[72] << 7 & 0x80) | (nv_bc_manager->is_ready_to_restore[73] << 6 & 0x40) | (nv_bc_manager->is_ready_to_restore[74] << 5 & 0x20) | (nv_bc_manager->is_ready_to_restore[75] << 4 & 0x10) | (nv_bc_manager->is_ready_to_restore[76] << 3 & 0x08) | (nv_bc_manager->is_ready_to_restore[77] << 2 & 0x04) | (nv_bc_manager->is_ready_to_restore[78] << 1 & 0x02) | (nv_bc_manager->is_ready_to_restore[79] & 0x01) ));
#endif
