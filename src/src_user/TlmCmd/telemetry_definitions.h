...
typedef enum
{
  ...
  Tlm_CODE_AOBC_TARGET_QUATERNION1 = 0x29,
  Tlm_CODE_AOBC_TARGET_QUATERNION2 = 0x2a,
  ...
  Tlm_CODE_AOBC_ATTITUDE_DETERMINATION1 = 0x38,
  Tlm_CODE_AOBC_ATTITUDE_DETERMINATION2 = 0x39,
