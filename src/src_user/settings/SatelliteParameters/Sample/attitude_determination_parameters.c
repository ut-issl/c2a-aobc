...
const APP_RTAD_SUN_INVISIBLE_PROPAGATION ATTITUDE_DETERMINATION_PARAMETERS_rtad_sun_invisible_propagation =
  APP_RTAD_SUN_INVISIBLE_PROPAGATION_QUATERNION;
...
const float ATTITUDE_DETERMINATION_PARAMETERS_ekf_process_noise_covariance_attitude_rate =
  ((MATH_CONST_2PI / ATTITUDE_PARAMETER_ORBIT_PERIOD_SEC * ATTITUDE_PARAMETER_COMPUTATION_CYCLE_SEC)) *
  ((MATH_CONST_2PI / ATTITUDE_PARAMETER_ORBIT_PERIOD_SEC * ATTITUDE_PARAMETER_COMPUTATION_CYCLE_SEC));
